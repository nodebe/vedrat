...
class User(db.Model, UserMixin):
	...
	fullname = db.Column(db.String(8), nullable=False)
	email = db.Column(db.String(50), unique=True, nullable=False)
	phone = db.Column(db.String(15), unique=True, nullable=False)
	password = db.Column(db.String(120), nullable=False)
	referrer = db.Column(db.String(10))
	bank_name = db.Column(db.String(90))
	acc_number = db.Column(db.Integer)
	acc_name = db.Column(db.String(70))
	plan = db.Column(db.String(1))
	balance = db.Column(db.Integer, default=0)
	account_status = db.Column(db.String(10), default='open')
	date_of_payment = db.Column(db.DateTime)
	ad_collected_on_day = db.Column(db.Integer)
	referred_plan_1 = db.Column(db.Integer)
	referred_plan_2 = db.Column(db.Integer)
